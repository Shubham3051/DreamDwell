      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          {user ? (
            ...
            <Link to="/login" className="px-6 py-2 bg-[#D4755B] text-white rounded-full text-xs font-black uppercase tracking-widest hover:bg-[#c2644d] transition-all shadow-lg shadow-[#D4755B]/10">
              Sign In
            </Link>
          )}
