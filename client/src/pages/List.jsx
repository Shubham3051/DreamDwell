    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#FAF8F4]">
        <div className="text-center">
          <div className="w-10 h-10 border-4 border-[#D4755B] border-t-transparent rounded-full animate-spin mx-auto mb-3"></div>
          <p className="text-[#5A5856]">Loading properties...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#FAF8F4] p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#D4755B] text-white px-4 py-2 rounded-xl hover:bg-[#C05E44] transition"
        >
      ...
      {properties.length === 0 ? (
        <div className="text-center py-20 bg-white rounded-2xl border border-[#E6D5C3]">
          <Home className="w-10 h-10 mx-auto text-[#E6D5C3] mb-3" />
          <p className="text-[#5A5856]">No properties found</p>
        </div>
      ) : (
        /* GRID */
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {properties.map((property) => (
            <motion.div
              key={property._id}
              whileHover={{ y: -4 }}
              className="bg-white rounded-2xl border border-[#E6D5C3] shadow-sm hover:shadow-md overflow-hidden transition"
            >
              {/* IMAGE */}
              <div className="h-48 bg-[#F5F1E8]">
                <img
              ...
              {/* CONTENT */}
              <div className="p-4">
                <h3 className="text-lg font-semibold text-[#1C1B1A]">
                  {property.title}
                </h3>
                ...
                {/* PRICE */}
                <p className="mt-2 font-bold text-[#D4755B]">
                  ₹ {property.price?.toLocaleString()}
                </p>

                {/* SPECS */}
                <div className="flex gap-3 text-xs text-[#5A5856] mt-2">
                  <span className="flex items-center gap-1">
                    <BedDouble className="w-3.5 h-3.5 text-[#D4755B]" />
                    {property.beds}
                  </span>
                  ...
                  <span className="flex items-center gap-1">
                    <Maximize className="w-3.5 h-3.5 text-[#D4755B]" />
                    {property.sqft}
                  </span>
                </div>
                ...
                <div className="mt-3 flex gap-2 text-xs">
                  <span className="bg-[#1C1B1A] text-white px-2 py-1 rounded-full">
                    {property.type}
                  </span>
                ...
                {/* DESCRIPTION */}
                <p className="mt-3 text-sm text-[#5A5856] line-clamp-2">
                ...
                <div className="mt-4 flex gap-2">
                  <button
                    ...
                    className="bg-[#1C1B1A] text-white px-3 py-1 rounded-lg text-sm hover:bg-black transition"
                  >
                    View
                  </button>
                  ...
                  <button
                    onClick={() =>
                      console.log("Saved:", property._id)
                    }
